  ...
  const approvals = [
    {
      request: {
        connect: {
          id: createdRequests[1].id, // Approved cleaning supplies request
        },
      },
      approver: {
        connect: {
          id: managerUser.id, // Manager
        },
      },
      status: 'APPROVED',
      level: 1,
    ...
    },
    {
      request: {
        connect: {
          id: createdRequests[3].id, // Approved kitchen supplies request
        },
      },
      approver: {
        connect: {
    ...
    },
    {
      request: {
        connect: {
          id: createdRequests[4].id, // Rejected safety equipment request
        },
      },
      approver: {
        connect: {
